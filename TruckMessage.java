public class TruckMessage {
	public TruckMessage (long leastVehicleId, long mostVehicleId, long leastGatewayId, long mostGatewayId, int groups, String tracker, double latitude, double longitude, double speed, long time) {
