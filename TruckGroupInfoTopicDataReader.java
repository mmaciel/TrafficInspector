...
public final class TruckGroupInfoTopicDataReader extends DataReader  {
  
  TruckGroupInfoTopicDataReader (Subscriber             s,
                        TopicDescription       td,
                        SWIGTYPE_p__DataReader j_dr) {
     super(s,td,j_dr);
  }
  public ReturnCode_t    read( TruckGroupInfoTopicSeq                   received_data,
    ...
    ReturnCode_t retval =  _read(tmp_seq, sample_infos, max_samples,
                                 ...
                                 TruckGroupInfoTopic.class);
    received_data.value = (TruckGroupInfoTopic[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    read_w_condition( TruckGroupInfoTopicSeq       received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
    ...
    ReturnCode_t retval =  _read_w_condition(tmp_seq, sample_infos, max_samples,
                                 condition, TruckGroupInfoTopic.class);
    received_data.value = (TruckGroupInfoTopic[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    read_next_sample( TruckGroupInfoTopic          received_data,
                                    SampleInfo  sample_info) {
    ReturnCode_t retval;
    TruckGroupInfoTopicSeq tmp_seq = new TruckGroupInfoTopicSeq();
  ...
  public ReturnCode_t    read_instance( TruckGroupInfoTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
  ...
  public ReturnCode_t    read_next_instance( TruckGroupInfoTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
  ...
  public ReturnCode_t    read_next_instance_w_condition( TruckGroupInfoTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 ReadCondition           condition) {
    ...
    ReturnCode_t retval =  _read_next_instance_w_condition(tmp_seq, sample_infos, max_samples,
                                 handle, condition, TruckGroupInfoTopic.class);
    received_data.value = (TruckGroupInfoTopic[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    take( TruckGroupInfoTopicSeq                   received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 long                    sample_states,
			 long                    view_states,
  ...
  public ReturnCode_t    take_w_condition( TruckGroupInfoTopicSeq       received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 ReadCondition           condition) {
    sample_infos.value  = null;
  ...
  public ReturnCode_t    take_next_sample( TruckGroupInfoTopic          received_data,
                                    SampleInfo  sample_info) {
    ReturnCode_t retval;
    TruckGroupInfoTopicSeq tmp_seq = new TruckGroupInfoTopicSeq();
    SampleInfoSeq si_seq = new SampleInfoSeq();
  ...
  public ReturnCode_t    take_instance( TruckGroupInfoTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 long                    sample_states,
  ...
  public ReturnCode_t    take_next_instance( TruckGroupInfoTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        prev_handle,
			 long                    sample_states,
  ...
  public ReturnCode_t    take_next_instance_w_condition( TruckGroupInfoTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 ReadCondition           condition) {
  ...
  public ReturnCode_t    return_loan( TruckGroupInfoTopicSeq                   received_data,
                                      SampleInfoSeq           sample_infos) {
