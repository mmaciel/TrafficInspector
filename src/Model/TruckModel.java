...
// Must be updated to reflect changes in TruckInformationTopic 
public class TruckModel {
	public TruckModel (long leastVehicleId, long mostVehicleId, long leastGatewayId, long mostGatewayId, GroupModel [] groups, String tracker, double latitude, double longitude, double speed, long time) {
	...
	public GroupModel [] getGroups() { return GROUPS; }
	public void setGroups(GroupModel value[]) { GROUPS = value; }
