...
public class TruckInformationTopic {
  ...
  public GroupTopic[] groupCollection;
  
  // constructors
  public TruckInformationTopic() {}
  public TruckInformationTopic( long __f1, long __f2, long __f3, long __f4, String __f5, TruckTrackingInformationTopic[] __f6, GroupTopic[] __f7 ) {
  ...
  public void copy( TruckInformationTopic from ) {
    ...
    this.groupCollection = from.groupCollection;
  }
