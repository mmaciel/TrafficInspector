...
public final class GroupTopicDataReader extends DataReader  {
  
  GroupTopicDataReader (Subscriber             s,
                        TopicDescription       td,
                        SWIGTYPE_p__DataReader j_dr) {
     super(s,td,j_dr);
  }
  public ReturnCode_t    read( GroupTopicSeq                   received_data,
    ...
    ReturnCode_t retval =  _read(tmp_seq, sample_infos, max_samples,
                                 ...
                                 GroupTopic.class);
    received_data.value = (GroupTopic[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    read_w_condition( GroupTopicSeq       received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
    ...
    ReturnCode_t retval =  _read_w_condition(tmp_seq, sample_infos, max_samples,
                                 condition, GroupTopic.class);
    received_data.value = (GroupTopic[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    read_next_sample( GroupTopic          received_data,
                                    SampleInfo  sample_info) {
    ReturnCode_t retval;
    GroupTopicSeq tmp_seq = new GroupTopicSeq();
  ...
  public ReturnCode_t    read_instance( GroupTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
  ...
  public ReturnCode_t    read_next_instance( GroupTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
  ...
  public ReturnCode_t    read_next_instance_w_condition( GroupTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 ReadCondition           condition) {
    ...
    ReturnCode_t retval =  _read_next_instance_w_condition(tmp_seq, sample_infos, max_samples,
                                 handle, condition, GroupTopic.class);
    received_data.value = (GroupTopic[])tmp_seq.value;
    return retval;
  }
  public ReturnCode_t    take( GroupTopicSeq                   received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 long                    sample_states,
			 long                    view_states,
  ...
  public ReturnCode_t    take_w_condition( GroupTopicSeq       received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 ReadCondition           condition) {
    sample_infos.value  = null;
  ...
  public ReturnCode_t    take_next_sample( GroupTopic          received_data,
                                    SampleInfo  sample_info) {
    ReturnCode_t retval;
    GroupTopicSeq tmp_seq = new GroupTopicSeq();
    SampleInfoSeq si_seq = new SampleInfoSeq();
  ...
  public ReturnCode_t    take_instance( GroupTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 long                    sample_states,
  ...
  public ReturnCode_t    take_next_instance( GroupTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        prev_handle,
			 long                    sample_states,
  ...
  public ReturnCode_t    take_next_instance_w_condition( GroupTopicSeq     received_data,
                        SampleInfoSeq           sample_infos,
			 int                     max_samples,
			 InstanceHandle_t        handle,
			 ReadCondition           condition) {
  ...
  public ReturnCode_t    return_loan( GroupTopicSeq                   received_data,
                                      SampleInfoSeq           sample_infos) {
